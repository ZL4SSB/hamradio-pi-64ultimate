...
class HamRadioPiUltimate:
    ...
    def build_tools_panel(self, parent) -> None:
        ...
        buttons = [
            ("Applications", self.open_application_browser),
    ...
    def refresh_weather(self) -> None:
        ...
        self.weather_value.set("Updating...")
    ...
    def _weather_worker(self) -> None:
        ...
        self.root.after(
            0,
            lambda: self._finish_weather_refresh(summary, settings),
        )
    ...
    def _finish_weather_refresh(
        ...
        if isinstance(weather_settings, dict):
            try:
                refresh_minutes = int(
                    weather_settings.get("refresh_minutes", 20)
                )
            except (TypeError, ValueError):
                refresh_minutes = 20

        refresh_minutes = max(5, min(refresh_minutes, 120))
